...
*
      IF (LSAME(TRANS,'N')) THEN
         CALL SGEMMT(UPLO,'N','T',N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
         CALL SGEMMT(UPLO,'N','T',N,K,MALPHA,B,LDB,A,LDA,ONE,C,LDC)
      ELSE
         CALL SGEMMT(UPLO,'T','N',N,K,ALPHA,A,LDA,B,LDB,BETA,C,LDC)
         CALL SGEMMT(UPLO,'T','N',N,K,MALPHA,B,LDB,A,LDA,ONE,C,LDC)
      END IF
*
      RETURN
*
